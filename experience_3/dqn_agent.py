...
SHOW_PREVIEW = True
LOAD_MODEL = 'tk_rl_____1.51max____1.13avg____0.04min__1569123037.model'
...
class DQNAgent:
    ...
    def create_model(self):
        ...
        if LOAD_MODEL != None:
            ...
            model = Sequential()
            model.add(Dense(16, input_shape=env.OBSERVATION_SPACE_VALUES))
    ...
    def get_qs_return(self, state):
        ...
        qs2 = qs[3:6]
        qs3 = qs[6:]
        return [np.argmax(qs1), np.argmax(qs2), np.argmax(qs3)]
